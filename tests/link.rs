...
use common::*;
use diagram_r::{Point, constants::ZERO_POINT, diagram::DiagramOpt, link::PointInLink};
#[test]
fn link_container_update_tests() {
    ...
    let cmp = lc.get_center(&PointInLink::NoMatch);
    ...
    assert_eq!(&res, &PointInLink::Bundle((lc.bundles[0].clone(), 0)));
